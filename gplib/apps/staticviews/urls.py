...
urlpatterns = patterns('',
            ...
            (r'adquisition/$', 'gplib.apps.staticviews.views.adquisition'),
            (r'tech_process/$', 'gplib.apps.staticviews.views.tech_process'),
            (r'authorize/csv/$', 'gplib.apps.staticviews.views.gen_authorize_csv'),
            (r'authorize/clear/$', 'gplib.apps.staticviews.views.authorize_clear'),
        )

...
urlpatterns = patterns('',
            (r'^$', 'gplib.apps.search.views.index'),
            (r'^filter/(?P<filtered>.+)$', 'gplib.apps.search.views.index'),
            (r'^data/?$', 'gplib.apps.search.views.data'),
            (r'^get_fields$', 'gplib.apps.search.views.get_fields'),
            (r'^admin/$', 'gplib.apps.search.views.admin'),
            (r'^newsearch/?$', 'gplib.apps.search.views.newsearch'),
            (r'^reference_complete/?$',
                'gplib.apps.search.views.reference_complete'),
           )

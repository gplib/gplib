...
class ExternalDatabases(models.Model):
    """
    Este es el modelo que tendra los datos de acceso
...
class ExternalQuery(models.Model):
    """
    Este modelo tendra queries relacionadas con las bases de datos externas
    """
    external_database = models.ForeignKey(ExternalDatabases)
    external_query = models.CharField(max_length=255)

    def __unicode__(self):
        return "%s en %s" % (self.external_query, self.external_database)


    
#Ejemplo de un model para una tabla echa
#class DrupalTest(models.Model):
#    id = models.IntegerField(primary_key=True)
#    nombre = models.CharField(max_length=765)
#    edad = models.IntegerField()
#    direccion = models.CharField(max_length=765)
#    class Meta:
#        db_table = u'drupal_test'

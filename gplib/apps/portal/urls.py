...
urlpatterns = patterns('',
                       (r'^$', 'gplib.apps.portal.views.index'),
                       (r'only_users/$', 'gplib.apps.portal.views.only_users'),
                       (r'only_staff/$', 'gplib.apps.portal.views.only_staff'),
                       (r'only_admins/$', 'gplib.apps.portal.views.only_admins'),
                       (r'only_biblio/$', 'gplib.apps.portal.views.only_biblio'),
)
